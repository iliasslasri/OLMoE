#!/bin/bash
#SBATCH --job-name=olmoe-lb-001
#SBATCH --output=olmoe-lb-001.out
#SBATCH --error=olmoe-lb-001.err
...
VENV_DIR="/tmp/olmoe_venv_lb_001"
python -m venv --system-site-packages "$VENV_DIR"
source "$VENV_DIR/bin/activate"

python /home/infres/zakil-22/OLMoE/train_server_lb_001.py
