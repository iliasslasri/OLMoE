#!/bin/bash
#SBATCH --job-name=olmoe-lb-0001
#SBATCH --output=olmoe-lb-0001.out
#SBATCH --error=olmoe-lb-0001.err
...
VENV_DIR="/tmp/olmoe_venv_lb_0001"
python -m venv --system-site-packages "$VENV_DIR"
source "$VENV_DIR/bin/activate"

python /home/infres/zakil-22/OLMoE/train_server_lb_0001.py
